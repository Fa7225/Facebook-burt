...
echo $i" |"$cy"     Indian DARK TERMUX ASSOCIATE"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" RISKI DARMAWAN  [Fa7225]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Riski Darmawan"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.P3RC1L] [MR.S∆MAx] [MR.B]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.S%] [AldykaPrygh]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" 9101877849"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" fardusahamed37@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
...
echo $i"────────────────────────────────    ─────"
echo
echo $me"┌==="$bi"["$i"Fa7225"$bi"]"$me"======"$bi"["$i""Pilih Nomornya""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
sleep 1
git clone https://github.com/Fa7225/fbbrute
cd fbbrute
php fb.php
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Fa7225/Fb-Cracker-v.3
cd Fb-Cracker-v.3
python2 crack.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Fa7225/mbf
cd mbf
python2 MBF.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Fa7225/EmailVuln
cd EmailVuln
python2 vuln.py
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Fa7225/ProfileGuardFb
cd ProfileGuardFb
php guard.php
fi
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Fa7225/InfoFB
cd InfoFB
...
figlet -f slant "W A I T"|lolcat
sleep 1
git clone https://github.com/Fa7225/autolike
cd autolike
php autolike.php
fi
...
sleep 2
echo $ku"WhatsApp :"$i" 9101877849"
echo $ku"Facebook :"$i" Vicky"
sleep 2
echo $pur">> Code edit by Ziaul <<"
exit
fi